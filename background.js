...
function decide_command(value) {
	if (value.indexOf("open") >= 0 || value.indexOf("new") >= 0 || value.indexOf("edit") >= 0) {
        ...
        else if (value == "facebook") chrome.tabs.create({
			"url": "http://www.facebook.com/"
		});
		else if (value == "google") chrome.tabs.create({
			"url": "http://www.google.com/"
		});
		else if (value == "yahoo") chrome.tabs.create({
			"url": "http://www.yahoo.com/"
		});
		else if (value == "twitter") chrome.tabs.create({
			"url": "http://www.twitter.com/"
		});
		else if (value == "flicker" || value == "flickr") chrome.tabs.create({
			"url": "http://www.flickr.com/"
		});
		else if (value == "msn") chrome.tabs.create({
			"url": "http://www.msn.com/"
		});
		else if (value == "hotmail") chrome.tabs.create({
			"url": "http://www.hotmail.com/"
		});
		else if (value == "dig" || value == "digg") chrome.tabs.create({
